        ...
        <div class="flex-1 rounded-lg px-4 py-2 sm:px-6 sm:py-4 leading-relaxed">
            ...
            <div class="flex flex-wrap -mx-3 mb-6 divide-y-2 divide-gray-400">
                <div class="w-full md:w-full px-3 mt-2">
                    <textarea wire:model="body" class="focus:outline-none rounded border-none leading-normal resize-none w-full h-20 font-medium placeholder-gray-700 focus:bg-white" name="body" placeholder='Type Your Comment' @click.prevent="open = !open"></textarea>
                </div>
